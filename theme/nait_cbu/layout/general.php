...
function ViewCourseOutline(){
 ...
 window.open('http://localhost:1111/CourseOutline/GetCourseOutlineForMoodleCourse?id=' + GetQuerystringValue("id") );
}
</script>
</head>
...
<div>
 <img src="http://academictools.nait.ca/Chart/GatherMoodleData?username=<?php echo $USER->username ?>&courseId=<?php echo $COURSE->id ?>&currentURL=<?php echo base64_encode($PAGE->url) ?>&timestamp=<?php echo time() ?>" />
</div>
</body>
</html>