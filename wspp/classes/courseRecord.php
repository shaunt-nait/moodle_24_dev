...
class courseRecord {
	...
	* @return courseRecord
	*/
	 public function courseRecord($error='',$id=0,$category=0,$sortorder=0,$fullname='',$shortname='',$idnumber='',$summary='',$format='',$showgrades=0,$newsitems=0,$numsections=0,$marker=0,$maxbytes=0,$visible=0,$hiddensections=0,$groupmode=0,$groupmodeforce=0,$lang='',$theme='',$timecreated=0,$timemodified=0){
		 $this->error=$error   ;
		 $this->id=$id   ;
