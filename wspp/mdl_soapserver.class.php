...
<faultstring>'.$info.'</faultstring>
    ...
    */
	...
	/**
       * Copy content from one course to another, deleting the destination course first
       *
       * @param int $client The client record ID.
       * @param string $sesskey The client session key.
       * @return boolean True 
       */
    public function exec_copy_content($client, $sesskey, $fromcourseid, $newcourse) {
        return parent :: exec_copy_content($client, $sesskey, $fromcourseid, $newcourse);
    }
    
    //NAIT: get online user count
	public function getOnlineUserCount($client, $sesskey, $minute) {
        return parent :: getOnlineUserCount($client, $sesskey, $minute);
    }
    ...
    * @return userRecord[]
    */
    public function get_users_bycourse($client, $sesskey, $idcourse, $idfield = 'idnumber', $idrole = '0', $idrolefield = 'id') {
        return $this->send($this->to_soap_array(parent :: get_users_bycourse($client, $sesskey, $idcourse, $idfield, $idrole,$idrolefield), 'users', 'userRecord', get_string('nousers', 'local_wspp')));
    ...
    */
    ...
    public function GetUserProfileBase64Image($userName, $passphrase, $size= '2') {
        return parent :: GetUserProfileBase64Image($userName, $passphrase, $size);
