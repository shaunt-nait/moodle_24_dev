...
function saml_hook_attribute_filter(&$saml_attributes) {
    ...
    // Inyectamos el curso que existe
    $saml_attributes['schacUserStatus'] = array ( 'urn:mace:terena.org:schac:userStatus:es:campusandaluzvirtual.es:99999999:2011-12:student:active' );
