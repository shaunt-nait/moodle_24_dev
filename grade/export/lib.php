...
abstract class grade_export {
    ...
    public function display_preview($require_user_idnumber=false) {
        ...
        echo '<th>'.get_string("firstname")."</th>".
        	 ...
        	 '<th>Class Section</th>'; // NAIT CHANGE - added class section ;;
        ...
        while ($userdata = $gui->next_user()) {
            ...
            echo '<tr>';
            echo "<td>$user->firstname</td><td>$user->lastname</td><td>$user->idnumber</td><td>$user->institution</td><td>$user->department</td><td>$user->email</td><td>$user->classsection</td>"; //NAIT CHANGE - include class section"
            echo $rowstr;
            echo "</tr>";
